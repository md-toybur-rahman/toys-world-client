...
const Banner = () => {
    return (
        <div className="flex justify-between items-center">
            ...
            {/* <div>
                <h3 className="text-2xl font-bold">Big fun for kids !</h3>
                <h1 className="text-7xl font-extrabold text-[#ff9000]">A World <br /> To Explore</h1>
                <p className="text-xl font-lg">Active toys for smart and active kids. Bring fun and non-stop <br /> learning for your little ones.</p>
